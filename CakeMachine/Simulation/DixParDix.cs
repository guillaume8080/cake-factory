    ...
    internal class DixParDix : Algorithme
    {
        ...
        public override IEnumerable<GâteauEmballé> Produire(Usine usine, CancellationToken token)
        {
            ...
            while (!token.IsCancellationRequested)
            {
                ...
                // TODO: Cuire par lot est vraiment trop couteux ... refacto
                // var gateauxCuitsSansMethodeCouteuse = gâteauxCrus.AsParallel().Select((_) => posteCuisson.Cuire(_));
        ...
        public override async IAsyncEnumerable<GâteauEmballé> ProduireAsync(Usine usine, [EnumeratorCancellation] CancellationToken token)
        {
            ...
            while (!token.IsCancellationRequested)
            {
                ...
                var gâteauxCrus = plats
                    ...
                    // cette methode nous permet d obtenir des POJO au lieu de TASK
                    .EnumerateCompleted();
